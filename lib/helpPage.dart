                        ...
                        RichText(
                          ...
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(text: 'на краску в рублях. Доступен выбор валюты для удобства расчетов.'+
                              ...
                              TextSpan(text: '. Точно его можно определить только экспериментально, так как влияет множество факторов:\n\n'+
                                  ...
                                  'Для получения идеальных теоретических значений данный параметр можно оставить равным 100%.\n', style: TextStyle(fontSize: 16.0, color: Colors.black, fontFamily: 'Ubuntu',)),
