...
class _mainScreenState extends State<mainScreen> {
  ...
  Widget build(BuildContext context) {
   ...
   return Scaffold(
     ...
     appBar:AppBar(
       elevation: 0.0,
       title:Text("PowderCalc 1.0.0", style: TextStyle(fontSize: 15.0, color: Colors.white, fontFamily: 'Ubuntu', fontWeight: FontWeight.bold)),
       centerTitle: true,
           ...
           child: Material(
             ...
             child: InkWell(
               ...
               onTap: () {
                 ...
                 Share.share('Калькулятор порошковой краски PowderCalc 1.0.0: https://apps.apple.com/us/app/%D0%BA%D0%B0%D0%BB%D1%8C%D0%BA%D1%83%D0%BB%D1%8F%D1%82%D0%BE%D1%80-%D0%BA%D1%80%D0%B0%D1%81%D0%BA%D0%B8-powdercalc/id1550802409#?platform=iphone',
                     subject: 'Калькулятор порошковой краски PowderCalc 1.0.0',
                     sharePositionOrigin:
                    ...
                    Text('   Исходные данные', style: TextStyle(fontSize: 14.0, color: Colors.black, fontFamily: 'Ubuntu',fontWeight: FontWeight.bold),textAlign: TextAlign.left,),
                     ...
                     Row(
                         ...
                         children: <Widget>[
                           ...
                           FlatButton.icon(
                             icon: Image.asset(curType==3?'images/rubBlue.png':'images/rubGrey.png',  height: 22,),
                   ...
                   //     children: <Widget>[
                    Center(
                          child:Container(
                             ...
                             // child:
                            //Expanded(
                              child:Text('Эффективность системы $effective %', style: TextStyle(fontSize: 14.0, color: Colors.black, fontFamily: 'Ubuntu',), textAlign: TextAlign.center,),
                            //),
                          ),
                    ),
                             /*ButtonTheme(
                        ...
                        RaisedButton.icon(
                          onPressed: () {
                            ...
                            Share.share(' Произведен расчет краски по следующим параметрам: \n'+
                                ...
                                'Эффективность системы: ${effective.round().toString()}%\n\n'+
                                ...
                                'Расчет произведен в приложении PowderCalc 1.0.0: https://apps.apple.com/us/app/%D0%BA%D0%B0%D0%BB%D1%8C%D0%BA%D1%83%D0%BB%D1%8F%D1%82%D0%BE%D1%80-%D0%BA%D1%80%D0%B0%D1%81%D0%BA%D0%B8-powdercalc/id1550802409#?platform=iphone',
